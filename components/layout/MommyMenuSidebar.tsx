...
export function MommyMenuSidebar({ onClose }: MommyMenuSidebarProps) {
  ...
  return (
    <div className="w-64 bg-gradient-to-b from-rose-50/30 via-pink-50/20 to-orange-50/30 border-r border-pink-200/40 flex flex-col backdrop-blur-sm relative overflow-hidden">
      {/* Decorative background elements */}
      <div className="absolute top-10 left-4 w-16 h-16 bg-gradient-to-br from-pink-200/20 to-rose-200/10 rounded-full blur-xl" />
      <div className="absolute bottom-20 right-4 w-12 h-12 bg-gradient-to-br from-orange-200/15 to-amber-200/10 rounded-full blur-lg" />
      
      {/* Header with close button for mobile */}
      {onClose && (
        <div className="p-4 border-b border-pink-200/40 flex items-center justify-between relative z-10">
          ...
          <Button variant="ghost" size="sm" onClick={onClose} className="p-2 hover:bg-pink-100/50">
      ...
      <nav className="flex-1 p-4 space-y-3 relative z-10">
        <div className="mb-6">
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-xs font-semibold text-pink-700 uppercase tracking-wide">메뉴</span>
          </div>
        </div>
            ...
            <Link
              ...
              className={cn(
                ...
                isActive
                  ...
                  : 'text-gray-700 hover:bg-white/60 hover:text-gray-900 hover:organic-shadow'
              )}
      ...
      <div className="p-4 border-t border-pink-200/40 relative z-10">
        <div className="bg-gradient-to-br from-pink-50/80 via-rose-50/60 to-orange-50/40 organic-rounded p-4 border border-pink-200/40 organic-shadow">
          <div className="flex items-center gap-2 mb-3">
            <Heart className="w-4 h-4 text-pink-500 heartbeat" />
            <span className="text-sm font-semibold text-pink-700">오늘의 영양 점수</span>
          </div>
          
          <div className="flex items-end gap-2 mb-2">
            <span className="text-3xl font-bold text-pink-600 tabular-nums">87</span>
            <span className="text-sm text-pink-500 mb-1">점</span>
          </div>
          ...
          <div className="flex justify-between items-center">
            <span className="text-xs text-pink-600">목표까지</span>
            <span className="text-xs font-semibold text-rose-600">13점</span>
          </div>
          
          {/* Motivational message */}
          <div className="mt-3 p-2 bg-white/50 organic-rounded border border-pink-100/50">
